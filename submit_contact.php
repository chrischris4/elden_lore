...
if (
    ...
    || !filter_var($postData['pseudo'], FILTER_VALIDATE_EMAIL)
    || empty($postData['message'])
    || trim($postData['message']) === ''
) {
    echo('Il faut un pseudo et un message valides pour soumettre le formulaire.');
    return;
}
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text"><b>Pseudo</b> : <?php echo($postData['pseudo']); ?></p>
